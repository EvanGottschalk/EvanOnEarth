...
//# Functions
  ...
  function mouseOver(event) {
    ...
    } else if (element_ID === 'alchmLogoImage' || element_ID === 'alchmSiteLink' || element_ID === 'alchmSignupLink') {
